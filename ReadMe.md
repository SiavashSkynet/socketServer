The following program is created by @SiavashSkynet.So this is really simple and fun si let's dive into it,  The program has been written in C++ by using QT framework.
